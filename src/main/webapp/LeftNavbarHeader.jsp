	...
	<div class="navbar-default sidebar" role="navigation">
		<div class="sidebar-nav navbar-collapse slimscrollsidebar">
			<ul class="nav" id="side-menu">
				...
				<li><a href="http://localhost:8080/crm06/user?pageeid=1"
					class="waves-effect"> <i class="fa fa-user fa-fw"
						aria-hidden="true"></i> <span class="hide-menu">Thành viên</span>
				</a></li>
				...
				<li><a href="http://localhost:8080/crm06/task?pageeid=1" class="waves-effect"><i
						class="fa fa-table fa-fw" aria-hidden="true"></i><span

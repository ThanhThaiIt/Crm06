            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <form class="form-horizontal form-material" action="edit_role?typee=2" method="post">
									...
									<div class="col-md-12">
										<input type="text" name="idU"
											class="form-control form-control-line" value="${roleByID.id}"
											readonly>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-12">
										<input type="text" name="fname" value="${roleByID.nameString}"
								...
								<div class="form-group">
									...
									<div class="col-md-12">
										<input type="text" name="lname" value="${roleByID.descripString}"
											placeholder="..." class="form-control form-control-line">
									</div>
								</div>
                                <div class="form-group">
